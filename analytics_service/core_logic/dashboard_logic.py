...
def _get_dashboard_data_from_db(
  ...
  top_products = dashboard_repo.get_top_products_for_month(analytics_db, year, month)
  top_performers = dashboard_repo.get_top_performers_for_month(analytics_db, year, month)
