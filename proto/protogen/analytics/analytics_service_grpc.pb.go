...
type AnalyticsServiceClient interface {
	...
	GenerateProductSalesSummary(ctx context.Context, in *GenerateProductSalesSummaryRequest, opts ...grpc.CallOption) (*GenerateProductSalesSummaryResponse, error)
	...
	GenerateEmployeePerformance(ctx context.Context, in *GenerateEmployeePerformanceRequest, opts ...grpc.CallOption) (*GenerateEmployeePerformanceResponse, error)
	// Customer Analytics
	...
	GenerateCustomerAnalytics(ctx context.Context, in *GenerateCustomerAnalyticsRequest, opts ...grpc.CallOption) (*GenerateCustomerAnalyticsResponse, error)
...
func (c *analyticsServiceClient) GenerateProductSalesSummary(ctx context.Context, in *GenerateProductSalesSummaryRequest, opts ...grpc.CallOption) (*GenerateProductSalesSummaryResponse, error) {
	out := new(GenerateProductSalesSummaryResponse)
	err := c.cc.Invoke(ctx, "/analytics.AnalyticsService/GenerateProductSalesSummary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analyticsServiceClient) GenerateEmployeePerformance(ctx context.Context, in *GenerateEmployeePerformanceRequest, opts ...grpc.CallOption) (*GenerateEmployeePerformanceResponse, error) {
	out := new(GenerateEmployeePerformanceResponse)
	err := c.cc.Invoke(ctx, "/analytics.AnalyticsService/GenerateEmployeePerformance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analyticsServiceClient) GenerateCustomerAnalytics(ctx context.Context, in *GenerateCustomerAnalyticsRequest, opts ...grpc.CallOption) (*GenerateCustomerAnalyticsResponse, error) {
	out := new(GenerateCustomerAnalyticsResponse)
	err := c.cc.Invoke(ctx, "/analytics.AnalyticsService/GenerateCustomerAnalytics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalyticsServiceServer interface {
	...
	GenerateProductSalesSummary(context.Context, *GenerateProductSalesSummaryRequest) (*GenerateProductSalesSummaryResponse, error)
	// Employee Performance Analytics
	...
	GenerateEmployeePerformance(context.Context, *GenerateEmployeePerformanceRequest) (*GenerateEmployeePerformanceResponse, error)
	// Customer Analytics
	...
	GenerateCustomerAnalytics(context.Context, *GenerateCustomerAnalyticsRequest) (*GenerateCustomerAnalyticsResponse, error)
	// Dashboard and Real-time
...
func (UnimplementedAnalyticsServiceServer) GenerateProductSalesSummary(context.Context, *GenerateProductSalesSummaryRequest) (*GenerateProductSalesSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateProductSalesSummary not implemented")
}
...
func (UnimplementedAnalyticsServiceServer) GenerateEmployeePerformance(context.Context, *GenerateEmployeePerformanceRequest) (*GenerateEmployeePerformanceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateEmployeePerformance not implemented")
}
...
func (UnimplementedAnalyticsServiceServer) GenerateCustomerAnalytics(context.Context, *GenerateCustomerAnalyticsRequest) (*GenerateCustomerAnalyticsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateCustomerAnalytics not implemented")
}
...
func _AnalyticsService_GenerateProductSalesSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateProductSalesSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServiceServer).GenerateProductSalesSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/analytics.AnalyticsService/GenerateProductSalesSummary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GenerateProductSalesSummary(ctx, req.(*GenerateProductSalesSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AnalyticsService_GenerateEmployeePerformance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateEmployeePerformanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServiceServer).GenerateEmployeePerformance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/analytics.AnalyticsService/GenerateEmployeePerformance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GenerateEmployeePerformance(ctx, req.(*GenerateEmployeePerformanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AnalyticsService_GenerateCustomerAnalytics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateCustomerAnalyticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServiceServer).GenerateCustomerAnalytics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/analytics.AnalyticsService/GenerateCustomerAnalytics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).GenerateCustomerAnalytics(ctx, req.(*GenerateCustomerAnalyticsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenerateProductSalesSummary",
			Handler:    _AnalyticsService_GenerateProductSalesSummary_Handler,
		},
		{
		...
		{
			MethodName: "GenerateEmployeePerformance",
			Handler:    _AnalyticsService_GenerateEmployeePerformance_Handler,
		},
		{
		...
		{
			MethodName: "GenerateCustomerAnalytics",
			Handler:    _AnalyticsService_GenerateCustomerAnalytics_Handler,
		},
		{
